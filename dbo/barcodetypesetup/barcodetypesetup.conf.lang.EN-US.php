...
$dbo->cols['bt_code']->caption->set('default', 'Barcode Type', 'text');
$dbo->cols['bt_name']->caption->set('default', 'Barcode name', 'text');
$dbo->cols['bt_format']->caption->set('default', 'Barcode format', 'text');
