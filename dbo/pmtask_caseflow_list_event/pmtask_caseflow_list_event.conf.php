...
$dbo->cols['pmf_specific_userid']->inputTypeDefault = 'text';
...
$dbo->cols['pmf_last_timer_check_date']->displayDataType = 'datetime';
$dbo->cols['pmf_last_timer_check_date']->inputTypeDefault = 'text';
$dbo->cols['pmf_last_timer_check_date']->format = 'DD-MON-YYYY HH:MIN AP';
