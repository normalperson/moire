...
$dbo->cols['js_forwardtocusttime']->caption->set('default', 'Forward to Customer Time', 'text');
...
$dbo->cols['pmc_id']->caption->set('default', 'pmc_id', 'text');
$dbo->cols['action']->caption->set('default', 'Action', 'text');
$dbo->cols['totalhours']->caption->set('default', 'Total Hours', 'text');
$dbo->cols['case']->caption->set('default', 'case', 'text');
$dbo->cols['slastatus']->caption->set('default', 'SLA Status', 'text');
