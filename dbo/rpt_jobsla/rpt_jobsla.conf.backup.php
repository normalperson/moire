...
$dbo->table = 'mjobsheet ';
$dbo->key = array();
$dbo->sql = 'select mjobsheet.*, fcorg.*,pmc_id,\'\' as action,
EXTRACT(HOUR FROM js_forwardtocusttime - js_request_date) as totalhours,
case when EXTRACT(HOUR FROM js_forwardtocusttime - js_request_date) <= 6 then \'WithinSLA\' else \'ExceedSLA\' end slastatus,
...
from mjobsheet left join fcpmcase on pmc_casekey = js_id and pmc_casetype = \'jobsheet\'
...
$dbo->cols['totalbarcode']->exportUseLookup = true;
...
$dbo->cols['action'] = new DBO_COL('action', 'unknown', '-2', '-1');
$dbo->cols['action']->inputTypeDefault = 'text';
$dbo->cols['action']->searchMode = 'exact';
$dbo->cols['action']->capContClassDefault = array();
$dbo->cols['action']->valContClassDefault = array();
$dbo->cols['action']->exportUseLookup = true;
$dbo->cols['action']->option->defaultMethod = 'text';
$dbo->cols['action']->option->searchMethod = 'text';
$dbo->cols['action']->option->listMethod = 'text';
$dbo->cols['action']->option->detailMethod = 'text';
$dbo->cols['action']->option->newMethod = 'text';
$dbo->cols['action']->option->editMethod = 'text';
$dbo->cols['totalhours'] = new DBO_COL('totalhours', 'float8', '8', '-1');
$dbo->cols['totalhours']->inputTypeDefault = 'text';
$dbo->cols['totalhours']->searchMode = 'exact';
$dbo->cols['totalhours']->capContClassDefault = array();
$dbo->cols['totalhours']->valContClassDefault = array();
$dbo->cols['totalhours']->option->defaultMethod = 'text';
$dbo->cols['totalhours']->option->searchMethod = 'text';
$dbo->cols['totalhours']->option->listMethod = 'text';
$dbo->cols['totalhours']->option->detailMethod = 'text';
$dbo->cols['totalhours']->option->newMethod = 'text';
$dbo->cols['totalhours']->option->editMethod = 'text';
$dbo->cols['case'] = new DBO_COL('case', 'text', '-1', '-1');
$dbo->cols['case']->inputTypeDefault = 'text';
$dbo->cols['case']->searchMode = 'exact';
$dbo->cols['case']->capContClassDefault = array();
$dbo->cols['case']->valContClassDefault = array();
$dbo->cols['case']->option->defaultMethod = 'text';
$dbo->cols['case']->option->searchMethod = 'text';
$dbo->cols['case']->option->listMethod = 'text';
$dbo->cols['case']->option->detailMethod = 'text';
$dbo->cols['case']->option->newMethod = 'text';
$dbo->cols['case']->option->editMethod = 'text';
$dbo->cols['slastatus'] = new DBO_COL('slastatus', 'text', '-1', '-1');
$dbo->cols['slastatus']->displayListModifierMethod = 'phpfunc';
$dbo->cols['slastatus']->displayListModifier = 'slaresult';
$dbo->cols['slastatus']->inputTypeDefault = 'text';
$dbo->cols['slastatus']->searchMode = 'exact';
$dbo->cols['slastatus']->capContClassDefault = array();
$dbo->cols['slastatus']->valContClassDefault = array();
$dbo->cols['slastatus']->option->defaultMethod = 'text';
$dbo->cols['slastatus']->option->searchMethod = 'text';
$dbo->cols['slastatus']->option->listMethod = 'text';
$dbo->cols['slastatus']->option->detailMethod = 'text';
$dbo->cols['slastatus']->option->newMethod = 'text';
$dbo->cols['slastatus']->option->editMethod = 'text';
...
class DBO_custom_rpt_jobsla extends DBO{
	function __construct(){
		parent::__construct();
	}
}

$dbo->newModifier = 'dbo_rpt_jobsla_custom_new';
function dbo_rpt_jobsla_custom_new($table, $cols, $dbo){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_rpt_jobsla_custom_edit';
function dbo_rpt_jobsla_custom_edit($table, $cols, $wheres, $dbo){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_rpt_jobsla_custom_search';
function dbo_rpt_jobsla_custom_search(&$search, $dbo){
}

$dbo->deleteModifier = 'dbo_rpt_jobsla_custom_delete';
function dbo_rpt_jobsla_custom_delete($table, $wheres, $dbo){
	global $DB;
	$ret = array();
...
function dbo_rpt_jobsla_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>