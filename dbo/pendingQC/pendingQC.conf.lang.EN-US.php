...
$dbo->cols['artwork']->caption->set('default', 'Final Artwork', 'text');
...
$dbo->cols['js_qcchecked']->caption->set('default', 'Reject reason', 'text');
...
$dbo->cols['js_totalinch']->caption->set('default', 'Total Inch', 'text');
