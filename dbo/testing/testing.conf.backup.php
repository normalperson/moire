...
$dbo->colNew = array('js_request_date', 'js_request_by', 'js_title');
...
class DBO_custom_testing extends DBO{
	function __construct(){
		parent::__construct();
	}
}

$dbo->newModifier = 'dbo_testing_custom_new';
function dbo_testing_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_testing_custom_edit';
function dbo_testing_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_testing_custom_search';
function dbo_testing_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_testing_custom_delete';
function dbo_testing_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_testing_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>