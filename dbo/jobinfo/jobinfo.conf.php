...
$dbo->table = 'mjobsheet';
$dbo->key = array('js_id');
$dbo->sql = 'select mjobsheet.*, \'\' category from mjobsheet';
$dbo->col = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_request_by', 'js_title', 'js_model', 'js_description', 'js_material_provided', 'js_color_1', 'js_color_2', 'js_color_3', 'js_color_4', 'js_angle_1', 'js_angle_2', 'js_angle_3', 'js_angle_4', 'js_bleeding', 'js_bleeding_remark', 'js_carcode', 'js_distortion', 'js_distortion_value', 'js_diecut_ind', 'js_diecut_no', 'js_category', 'js_trapping_size', 'js_barcodetype', 'js_barcodenumber', 'js_primcat', 'js_status', 'js_completiondate', 'js_assignto', 'category');
$dbo->colList = array('js_title', 'js_model', 'js_ctid', 'js_description', 'js_category', 'js_trapping_size', 'js_barcodetype', 'js_barcodenumber');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('js_title', 'js_model', 'js_ctid', 'category', 'js_trapping_size', 'js_barcodetype', 'js_barcodenumber');
$dbo->colNew = array('js_title', 'js_model', 'js_ctid', 'category', 'js_trapping_size', 'js_barcodetype', 'js_barcodenumber');
$dbo->colEdit = array('js_cuid', 'js_ctid', 'js_request_date', 'js_request_by', 'js_title', 'js_model', 'js_description', 'js_material_provided', 'js_color_1', 'js_color_2', 'js_color_3', 'js_color_4', 'js_angle_1', 'js_angle_2', 'js_angle_3', 'js_angle_4', 'js_bleeding', 'js_bleeding_remark', 'js_carcode', 'js_distortion', 'js_distortion_value', 'js_diecut_ind', 'js_diecut_no', 'js_category', 'js_trapping_size');
...
$dbo->cols['js_ctid']->option->default = 'James
Iverson
MacGrady
Durant
Kobe';
...
$dbo->cols['category'] = new DBO_COL('category', 'unknown', '-2', '-1');
$dbo->cols['category']->inputTypeDefault = 'checkbox';
$dbo->cols['category']->searchMode = 'exact';
$dbo->cols['category']->capContClassDefault = array();
$dbo->cols['category']->valContClassDefault = array();
$dbo->cols['category']->valContExtClassDefault = 'inline-block';
$dbo->cols['category']->option->default = 'select jcl_id, jcl_title from mjobcatlookup
order by jcl_sequence';
$dbo->cols['category']->option->defaultMethod = 'sql';
$dbo->cols['category']->option->searchMethod = 'text';
$dbo->cols['category']->option->listMethod = 'text';
$dbo->cols['category']->option->detailMethod = 'text';
$dbo->cols['category']->option->newMethod = 'text';
$dbo->cols['category']->option->editMethod = 'text';
...
/*
$dbo->newModifier = 'dbo_jobinfo_custom_new';
function dbo_jobinfo_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_jobinfo_custom_edit';
function dbo_jobinfo_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_jobinfo_custom_search';
function dbo_jobinfo_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_jobinfo_custom_delete';
function dbo_jobinfo_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_jobinfo_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>