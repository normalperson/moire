...
$dbo->sql = 'select fcuser.*,fcorg.*,\'\' userRole, \'\' as currpassword, \'\' as password1, \'\' as password2 
from fcuser 
join fcuserorgrole on uor_usrid = usr_userid and uor_seq = 1
join fcorg on uor_orgid = org_id
where usr_userid in (select distinct uor_usrid from fcuserorgrole join fcrole on rol_id = uor_rolid join fcorg on org_id = uor_orgid where org_external =\'Y\')';
$dbo->col = array('usr_userid', 'usr_password', 'usr_created', 'usr_name', 'usr_email', 'usr_last_active', 'usr_last_success_login', 'usr_last_fail_login', 'usr_group', 'usr_sessiondata', 'usr_status', 'usr_langcode', 'org_id', 'org_type', 'org_external', 'org_name', 'org_parentid', 'org_primaryid', 'org_address', 'org_contactno', 'org_status', 'org_lccode', 'org_concode', 'org_region', 'org_created', 'userrole', 'currpassword', 'password1', 'password2');
$dbo->colList = array('usr_userid', 'usr_name', 'org_name', 'usr_email', 'usr_created', 'usr_status');
...
$dbo->colSearch = array('usr_userid', 'usr_name', 'org_id', 'usr_status');
...
$dbo->cols['org_id']->option->default = 'select org_id,org_name from fcorg
order by org_name';
