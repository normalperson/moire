...
$dbo->cols['printbutton']->displayListModifier = '<button class="btn btn-labeled btn-primary" style="min-width:85px;" form="noform" onclick="printJobPreview({js_id});"><span class="btn-label icon fa fa-print"></span>Print</button>';
