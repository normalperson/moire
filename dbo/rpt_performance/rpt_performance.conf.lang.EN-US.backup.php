...
$dbo->cols['count']->caption->set('default', 'Total activity', 'text');
$dbo->cols['pmf_end_by']->caption->set('default', 'pmf_end_by', 'text');
$dbo->cols['actvdate']->caption->set('default', 'Date', 'text');
$dbo->cols['usr_name']->caption->set('default', 'User name', 'text');
$dbo->cols['complysla']->caption->set('default', 'Comply SLA', 'text');
$dbo->cols['within50']->caption->set('default', 'Exceeded SLA by between 0% - 50%', 'text');
$dbo->cols['within100']->caption->set('default', 'Exceeded SLA by between 50% - 100%', 'text');
$dbo->cols['morethan100']->caption->set('default', 'Exceeded SLA by more than 100%', 'text');
