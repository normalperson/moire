...
$dbo->colExport = array('js_id', 'js_code', 'js_description', 'js_status', 'js_forwardtocusttime', 'js_request_by', 'js_assignto', 'js_totalinch');
$dbo->colSort = array();
$dbo->colSum = array();
...
$dbo->cols['js_orgid']->inputTypeDefault = 'Select2';
...
$dbo->cols['js_forwardtocusttime']->format = 'DD-MON-YYYY HH12:MIN:SS AP';
...
class DBO_custom_rpt_job extends DBO{
	function __construct(){
		parent::__construct();
	}
}

$dbo->newModifier = 'dbo_rpt_job_custom_new';
function dbo_rpt_job_custom_new($table, $cols, $dbo){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_rpt_job_custom_edit';
function dbo_rpt_job_custom_edit($table, $cols, $wheres, $dbo){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_rpt_job_custom_search';
function dbo_rpt_job_custom_search(&$search, $dbo){
}

$dbo->deleteModifier = 'dbo_rpt_job_custom_delete';
function dbo_rpt_job_custom_delete($table, $wheres, $dbo){
	global $DB;
	$ret = array();
...
function dbo_rpt_job_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>