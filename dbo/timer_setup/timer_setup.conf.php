...
$dbo->colList = array('pmev_name', 'pmev_timer_interval');
...
$dbo->colEdit = array('pmev_name', 'pmev_timer_interval');
...
$dbo->cols['pmev_timer_workinghours_only']->inputTypeDefault = 'text';
