<style type="text/css">
#dbotab_flowsummarymtd_detail_tbody_2 .caption{
	display:none;
}
</style>
...
<?php
require(dirname(__FILE__).DIRECTORY_SEPARATOR.'flowsummarymtd.conf.php');
...
function displayCartonDetail($col, $colVal, $data=array(), $html=null){
	$str = "<script>getCarton(".$colVal.",'dbotab_flowsummarymtd_detail_tbody_1',".$data['js_id'].",true)</script>";
	$html .= $str;
