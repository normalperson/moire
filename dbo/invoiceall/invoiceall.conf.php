...
$dbo->table = 'minvoice';
$dbo->key = array('iv_id');
$dbo->sql = 'select * from minvoice';
$dbo->col = array('iv_id', 'iv_invoicedate', 'iv_created', 'iv_orgid', 'iv_amount', 'iv_paid', 'iv_paydate');
$dbo->colList = array('iv_orgid', 'iv_invoicedate', 'iv_amount', 'iv_paid', 'iv_paydate');
