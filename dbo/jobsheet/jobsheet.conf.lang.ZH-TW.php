...
$dbo->cols['js_bleeding_remark']->caption->set('default', '出血/滲色備註', 'text');
...
$dbo->cols['js_carid']->caption->set('default', '訂單顏色 <br> (顏色類型)', 'text');
...
$dbo->cols['js_lpi']->caption->set('default', '線條網', 'text');
...
$dbo->cols['js_cartonsize_l1']->caption->set('default', '紙箱尺寸', 'text');
