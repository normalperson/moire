...
$dbo->cols['js_color_6']->caption->set('default', 'Color6', 'text');
$dbo->cols['js_color_7']->caption->set('default', 'Color7', 'text');
$dbo->cols['js_color_8']->caption->set('default', 'Color8', 'text');
$dbo->cols['js_cartonsize_g']->caption->set('default', 'G', 'text');
$dbo->cols['js_cartonsize_l1']->caption->set('default', 'L1', 'text');
$dbo->cols['js_cartonsize_w2']->caption->set('default', 'W2', 'text');
...
$dbo->cols['js_expectdelivery']->caption->set('default', 'Urgent / Expected Delivery Time', 'text');
...
$dbo->text->editCancel = 'Cancel Job';
$dbo->text->editSubmit = 'Resubmit';
