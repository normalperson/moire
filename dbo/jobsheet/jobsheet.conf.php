...
$dbo->cols['js_mcid']->option->new = 'select mc_id, mc_name, org_name from mcustmachine join fcorg on mc_orgid = org_id where org_id =9 order by 3,2';
$dbo->cols['js_mcid']->option->edit = 'select mc_id, mc_name, org_name from mcustmachine join fcorg on mc_orgid = org_id where org_id =9 order by 3,2';
