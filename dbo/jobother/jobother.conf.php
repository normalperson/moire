...
$dbo->table = 'mjobsheet';
$dbo->key = array('js_id');
$dbo->sql = 'select mjobsheet.*, \'\' as attachment from mjobsheet';
$dbo->col = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_request_by', 'js_title', 'js_model', 'js_description', 'js_material_provided', 'js_color_1', 'js_color_2', 'js_color_3', 'js_color_4', 'js_angle_1', 'js_angle_2', 'js_angle_3', 'js_angle_4', 'js_bleeding', 'js_bleeding_remark', 'js_carcode', 'js_distortion', 'js_distortion_value', 'js_diecut_ind', 'js_diecut_no', 'js_category', 'js_trapping_size', 'js_barcodetype', 'js_barcodenumber', 'js_primcat', 'js_status', 'js_completiondate', 'js_assignto', 'attachment');
$dbo->colList = array('js_description', 'js_distortion', 'js_distortion_value', 'js_diecut_ind', 'js_diecut_no');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('attachment', 'js_description');
$dbo->colNew = array('attachment', 'js_description');
$dbo->colEdit = array('attachment', 'js_description');
...
$dbo->cols['attachment']->displayDetailModifierMethod = 'phpfunc';
$dbo->cols['attachment']->displayDetailModifier = 'downloadlink';
...
/*
$dbo->newModifier = 'dbo_jobother_custom_new';
function dbo_jobother_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_jobother_custom_edit';
function dbo_jobother_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_jobother_custom_search';
function dbo_jobother_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_jobother_custom_delete';
function dbo_jobother_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_jobother_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>