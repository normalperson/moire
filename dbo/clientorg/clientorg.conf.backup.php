...
$dbo->sql = 'select * from fcorg join mcustomertype on org_id = tp_orgid 
where org_external = \'Y\'';
$dbo->col = array('org_id', 'org_type', 'org_external', 'org_name', 'org_parentid', 'org_primaryid', 'org_address', 'org_contactno', 'org_status', 'org_lccode', 'org_concode', 'org_region', 'org_created', 'tp_id', 'tp_orgid', 'tp_customertype');
...
$dbo->colNew = array('org_name', 'org_address', 'org_contactno', 'org_status', 'org_external', 'org_region', 'tp_customertype');
$dbo->colEdit = array('org_name', 'org_address', 'org_contactno', 'org_status', 'org_external', 'org_region', 'tp_customertype');
...
$dbo->cols['tp_customertype']->inputTypeDefault = 'select';
