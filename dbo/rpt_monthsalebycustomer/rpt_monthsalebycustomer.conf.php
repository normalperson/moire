...
$dbo->table = 'mjobsheet ';
$dbo->key = array();
$dbo->sql = 'select to_char(js_completiondate, \'YYYYMM\') as dateinnum,to_char(js_completiondate,\'MON-YYYY\') as js_request_dateinmth  ,org_name,count(*) totaljobrequested,org_id,
...
group by to_char(js_completiondate, \'YYYYMM\'),to_char(js_completiondate,\'MON-YYYY\'),org_name,org_id
order by to_char(js_completiondate, \'YYYYMM\')';
...
$dbo->cols['totalwip']->displayListModifierMethod = 'phpfunc';
$dbo->cols['totalwip']->displayListModifier = 'jobsummarylink';
...
$dbo->cols['totalcancelled']->displayListModifierMethod = 'phpfunc';
$dbo->cols['totalcancelled']->displayListModifier = 'jobsummarylink';
...
$dbo->cols['totalcompleted']->displayListModifierMethod = 'phpfunc';
$dbo->cols['totalcompleted']->displayListModifier = 'jobsummarylink';
