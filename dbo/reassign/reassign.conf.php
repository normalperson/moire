...
function dbo_reassign_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
function dbo_reassign_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_reassign_custom_delete';
function dbo_reassign_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
