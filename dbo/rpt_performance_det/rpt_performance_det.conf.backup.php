...
$dbo->whereSQL = '( ( timediffinmin(pmf_start_date, pmf_end_date) - timediffinmin(pmf_start_date, pmf_due_date) ) / timediffinmin(pmf_start_date, pmf_due_date) ) * 100 < 0 and pmf_end_by = \'uat_qc1\' and pmf_start_date > \'2014-07-14\' and pmf_start_date <= cast(\'2014-07-14\' as date) + interval \'1 day\'';
