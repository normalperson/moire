...
$dbo->cols['action']->displayListModifierMethod = 'phpfunc';
$dbo->cols['action']->displayListModifier = 'showActionButtons';
...
function dbo_rpt_jobdetail_custom_new($table, $cols, $dbo){
	global $DB;
	$ret = array();
...
function dbo_rpt_jobdetail_custom_edit($table, $cols, $wheres, $dbo){
	global $DB;
	$ret = array();
...
function dbo_rpt_jobdetail_custom_search(&$search, $dbo){
}

$dbo->deleteModifier = 'dbo_rpt_jobdetail_custom_delete';
function dbo_rpt_jobdetail_custom_delete($table, $wheres, $dbo){
	global $DB;
	$ret = array();
