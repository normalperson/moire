...
$dbo->colList = array('lu_code', 'lu_title', 'lu_status');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('lu_cat', 'lu_code', 'lu_parentcode', 'lu_title', 'lu_status', 'lu_id');
$dbo->colNew = array('lu_code', 'lu_title');
$dbo->colEdit = array('lu_code', 'lu_title', 'lu_status');
...
$dbo->cols['lu_cat']->option->defaultMethod = 'text';
...
$dbo->cols['lu_status']->inputTypeDefault = 'PixelAdminRadio';
...
class DBO_custom_customertype extends DBO{
...
$dbo->editModifier = 'dbo_customertype_custom_edit';
function dbo_customertype_custom_edit($table, $cols, $wheres, $dbo){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_customertype_custom_search';
function dbo_customertype_custom_search(&$search, $dbo){
}

$dbo->deleteModifier = 'dbo_customertype_custom_delete';
function dbo_customertype_custom_delete($table, $wheres, $dbo){
	global $DB;
	$ret = array();
...
function dbo_customertype_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>