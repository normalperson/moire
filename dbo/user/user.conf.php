...
order by usr_userid';
$dbo->col = array('usr_userid', 'usr_password', 'usr_created', 'usr_name', 'usr_email', 'usr_last_active', 'usr_last_success_login', 'usr_last_fail_login', 'usr_group', 'usr_sessiondata', 'usr_status', 'usr_langcode', 'userrole', 'currpassword', 'newpassword', 'newpassword2');
...
$dbo->cols['usr_langid'] = new DBO_COL('usr_langid', 'int4', '4', '-1');
...
$dbo->cols['newpassword'] = new DBO_COL('newpassword', 'unknown', '-2', '-1');
...
$dbo->cols['newpassword2'] = new DBO_COL('newpassword2', 'unknown', '-2', '-1');
