...
from fcpmcaseflow join fcpmcase on pmf_pmcid = pmc_id 
 join mjobsheet on js_id = pmc_casekey and pmc_casetype = \'jobsheet\' 
...
class DBO_custom_rpt_flowdetail extends DBO{
	function __construct(){
		parent::__construct();
	}
}

$dbo->newModifier = 'dbo_rpt_flowdetail_custom_new';
function dbo_rpt_flowdetail_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_rpt_flowdetail_custom_edit';
function dbo_rpt_flowdetail_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_rpt_flowdetail_custom_search';
function dbo_rpt_flowdetail_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_rpt_flowdetail_custom_delete';
function dbo_rpt_flowdetail_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_rpt_flowdetail_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>