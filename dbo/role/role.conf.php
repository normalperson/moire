...
$dbo->sql = 'select fcrole.*,(select string_agg(rp_pmscode, \', \') from fcroleperm where rp_rolid=rol_id and rp_pmscode is not null) as rol_permission from fcrole';
$dbo->col = array('rol_id', 'rol_name', 'rol_permission');
$dbo->colList = array('rol_name');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array();
$dbo->colNew = array('rol_permission');
$dbo->colEdit = array('rol_permission');
...
$dbo->maxSortCount = 9;
$dbo->defaultDateFormat = 'd-mon-yyyy';
$dbo->defaultDateTimeFormat = 'd-mon-yyyy h12:min AP';
...
$dbo->cols['rol_permission'] = new DBO_COL('rol_permission', 'text', '-1', '-1');
...
$dbo->cols['rol_name'] = new DBO_COL('rol_name', 'varchar', '-1', '2004');
