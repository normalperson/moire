...
$dbo->colList = array('js_id', 'org_name', 'ct_name', 'js_request_date', 'taskaging', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_title', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colNew = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_title', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colEdit = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_title', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colSearch = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_title', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colExport = array('js_id', 'js_cuid', 'js_ctid', 'js_request_date', 'js_title', 'js_status', 'js_completiondate', 'js_assignto');
$dbo->colSort = array();
$dbo->canSearch = false;
$dbo->canNew = false;
$dbo->canEdit = false;
...
$dbo->cols['taskaging']->displayListModifierMethod = 'phpfunc';
$dbo->cols['taskaging']->displayListModifier = 'timer';
...
/*
$dbo->newModifier = 'dbo_ackjob_custom_new';
function dbo_ackjob_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_ackjob_custom_edit';
function dbo_ackjob_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_ackjob_custom_search';
function dbo_ackjob_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_ackjob_custom_delete';
function dbo_ackjob_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_ackjob_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>