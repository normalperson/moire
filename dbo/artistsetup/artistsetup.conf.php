...
$dbo->sql = 'select fcuser.*,\'\' userRole, \'\' as currpassword, \'\' as password1, \'\' as password2, string_agg(distinct cast(ma_jclid as varchar), \', \') as skillids, 
string_agg(distinct cast(uor_orgid as varchar), \', \') as orgids 
from fcuser join fcuserorgrole on usr_userid = uor_usrid 
join fcorg on uor_orgid = org_id 
join fcrole on rol_id = uor_rolid 
left join martistskill on usr_userid = ma_usruserid 
where lower(rol_name) = \'artist\'
group by usr_userid ';
$dbo->col = array('usr_userid', 'usr_password', 'usr_created', 'usr_name', 'usr_email', 'usr_last_active', 'usr_last_success_login', 'usr_last_fail_login', 'usr_group', 'usr_sessiondata', 'usr_status', 'usr_langcode', 'userrole', 'currpassword', 'password1', 'password2', 'skillids', 'orgids');
$dbo->colList = array('usr_userid', 'usr_name', 'usr_email', 'usr_created', 'usr_status');
$dbo->colListEdit = array('usr_status');
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('usr_userid', 'usr_created', 'usr_name', 'usr_email', 'usr_last_active', 'usr_last_success_login', 'usr_last_fail_login', 'usr_status', 'skillids');
$dbo->colNew = array('usr_userid', 'password1', 'password2', 'usr_name', 'usr_email', 'usr_status', 'orgids', 'skillids');
$dbo->colEdit = array('usr_userid', 'usr_name', 'usr_email', 'usr_status', 'password1', 'password2', 'orgids', 'skillids');
...
$dbo->whereSQL = 'usr_userid in (\'uat_supervisor3\', \'yys1988@gmail.com\', \'yow@phiorion.com\', \'lampard7824@gmail.com\', \'admin2\', \'uat_qc1\', \'uat_customer2\', \'fongartist\', \'uat_customer5\', \'uat_supervisor4\', \'ysyow\', \'natasha\', \'esp@phiorion.com\', \'fred\', \'fongcustomer\', \'esp_supervisor\', \'esp_artist\', \'customer\', \'uat_supervisor1\', \'uat_cust1\', \'harry\', \'uat_supervisor2\', \'hongyee@phiorion.com\', \'Test\', \'thor@gmail.com\', \'fongsupervisor\', \'uat_customer4\', \'fong@phiorion.com\', \'artist2\', \'artist1\', \'uat_customer1\', \'admin\', \'uat_artist1\', \'uat_customer3\', \'danny@phiorion.com\', \'nick\', \'qc\', \'supervisor\', \'uat_supervisor5\', \'severus\', \'fongadmin\', \'superman@gmail.com\', \'tony\', \'uat_manager1\', \'albus\', \'uat_artist2\', \'esp\')';
...
$dbo->cols['usr_status']->defaultNewValue = 'ACTIVE';
...
$dbo->cols['skillids']->option->default = 'select jcl_id, jcl_title from mjobcatlookup order by 2';
...
$dbo->cols['orgids'] = new DBO_COL('orgids', 'text', '-1', '-1');
$dbo->cols['orgids']->inputTypeDefault = 'select';
$dbo->cols['orgids']->searchMode = 'exact';
$dbo->cols['orgids']->capContClassDefault = array();
$dbo->cols['orgids']->valContClassDefault = array();
$dbo->cols['orgids']->option->default = 'select org_id, org_name from fcorg where org_external = \'N\' order by org_id';
$dbo->cols['orgids']->option->defaultMethod = 'sql';
$dbo->cols['orgids']->option->searchMethod = 'text';
$dbo->cols['orgids']->option->listMethod = 'text';
$dbo->cols['orgids']->option->detailMethod = 'text';
$dbo->cols['orgids']->option->newMethod = 'text';
$dbo->cols['orgids']->option->editMethod = 'text';
