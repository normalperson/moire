...
$dbo->table = 'fcrule';
$dbo->key = array('ru_id');
$dbo->sql = 'select a.* from fcrule a order by ru_name';
...
$dbo->cols['testselect'] = new DBO_COL('testselect', 'unknown', '-2', '-1');
$dbo->cols['testselect']->inputNewModifierMethod = 'phpfunc';
$dbo->cols['testselect']->inputEditModifierMethod = 'phpfunc';
$dbo->cols['testselect']->inputNewModifier = 'showRuleSelector';
$dbo->cols['testselect']->inputEditModifier = 'showRuleSelector';
$dbo->cols['testselect']->inputTypeDefault = 'text';
$dbo->cols['testselect']->searchMode = 'exact';
$dbo->cols['testselect']->capContClassDefault = array();
$dbo->cols['testselect']->valContClassDefault = array();
$dbo->cols['testselect']->option->defaultMethod = 'text';
$dbo->cols['testselect']->option->searchMethod = 'text';
$dbo->cols['testselect']->option->listMethod = 'text';
$dbo->cols['testselect']->option->detailMethod = 'text';
$dbo->cols['testselect']->option->newMethod = 'text';
$dbo->cols['testselect']->option->editMethod = 'text';
