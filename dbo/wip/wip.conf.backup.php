...
$dbo->colNew = array('remark');
$dbo->colEdit = array('js_totalinch', 'artwork', 'remark');
...
$dbo->cols['artwork']->size = '1=300M/5';
...
$dbo->cols['js_width']->displayDataType = 'currency';
$dbo->cols['js_width']->inputTypeDefault = 'TextInputControl';
$dbo->cols['js_width']->mandatoryNew = '1';
$dbo->cols['js_width']->mandatoryEdit = '1';
...
$dbo->cols['js_height']->displayDataType = 'currency';
$dbo->cols['js_height']->inputTypeDefault = 'TextInputControl';
$dbo->cols['js_height']->mandatoryNew = '1';
$dbo->cols['js_height']->mandatoryEdit = '1';
...
$dbo->cols['js_totalinch']->inputTypeDefault = 'TextInputControl';
$dbo->cols['js_totalinch']->mandatoryDefault = '1';
...
class DBO_custom_wip extends DBO{
...
function dbo_wip_custom_new($table, $cols, $dbo){
	global $DB;
	$ret = array();
...
function dbo_wip_custom_edit($table, $cols, $wheres, $dbo){
	global $DB;
	$ret = array();
...
function dbo_wip_custom_search(&$search, $dbo){
}

$dbo->deleteModifier = 'dbo_wip_custom_delete';
function dbo_wip_custom_delete($table, $wheres, $dbo){
	global $DB;
	$ret = array();
