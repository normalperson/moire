...
/*
$dbo->newModifier = 'dbo_Report_custom_new';
function dbo_Report_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_Report_custom_edit';
function dbo_Report_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_Report_custom_search';
function dbo_Report_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_Report_custom_delete';
function dbo_Report_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_Report_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>