...
$dboID = 'tmp_monthsalesbycustomer';
$dbo = DBO_init($dboID);
$dbo->id = $dboID;
$dbo->table = 'tmp_monthsalesbycustomer';
$dbo->key = array('tmp_customername');
$dbo->sql = 'select * from tmp_monthsalesbycustomer';
$dbo->col = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colList = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesmay', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colListEdit = array();
$dbo->colListNew = array();
$dbo->colListGlobalInput = array();
$dbo->colDetail = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colNew = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colEdit = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colSearch = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colExport = array('tmp_customername', 'tmp_salesjan', 'tmp_salesfeb', 'tmp_salesmarch', 'tmp_salesapril', 'tmp_salesmay', 'tmp_salesjune', 'tmp_salesjuly', 'tmp_salesaug', 'tmp_salessept', 'tmp_salesoct', 'tmp_salesnov', 'tmp_salesdev');
$dbo->colSort = array();
$dbo->canSearch = false;
$dbo->canNew = true;
$dbo->canEdit = false;
...
/*
$dbo->newModifier = 'dbo_tmp_monthsalesbycustomer_custom_new';
function dbo_tmp_monthsalesbycustomer_custom_new($table, $cols){
	global $DB;
	$ret = array();
...
$dbo->editModifier = 'dbo_tmp_monthsalesbycustomer_custom_edit';
function dbo_tmp_monthsalesbycustomer_custom_edit($table, $cols, $wheres){
	global $DB;
	$ret = array();
...
$dbo->searchModifier = 'dbo_tmp_monthsalesbycustomer_custom_search';
function dbo_tmp_monthsalesbycustomer_custom_search(&$search){
}

$dbo->deleteModifier = 'dbo_tmp_monthsalesbycustomer_custom_delete';
function dbo_tmp_monthsalesbycustomer_custom_delete($table, $wheres){
	global $DB;
	$ret = array();
...
function dbo_tmp_monthsalesbycustomer_display_modifier($col, $colVal, $data=array(), $html=null){
}
*/
?>