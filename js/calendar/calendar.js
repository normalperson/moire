...
(function($) {
	...
	Calendar.prototype._render = function() {
		...
		if(getExtentedOption(this, 'first_day') == 1 && getExtentedOption(this, 'cellsize') =='normal') {
			data.months = [this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6, this.locale.d0]
		} else if (getExtentedOption(this, 'first_day') != 1 && getExtentedOption(this, 'cellsize') =='normal')  {
			data.months = [this.locale.d0, this.locale.d1, this.locale.d2, this.locale.d3, this.locale.d4, this.locale.d5, this.locale.d6]
		} else if (getExtentedOption(this, 'first_day') != 1 && getExtentedOption(this, 'cellsize') =='small')  {
			data.months = [this.locale.ds0, this.locale.ds1, this.locale.ds2, this.locale.ds3, this.locale.ds4, this.locale.ds5, this.locale.ds6]
		} else if (getExtentedOption(this, 'first_day') == 1 && getExtentedOption(this, 'cellsize') =='small')  {
			data.months = [this.locale.ds1, this.locale.ds2, this.locale.ds3, this.locale.ds4, this.locale.ds5, this.locale.ds6, this.locale.ds0]
		}
					...
					.on('show.bs.modal', function() {
						...
						switch(self.options.modal_type) {
							...
							case "ajax":
								...
								if (typeof self.options.ajax_option == 'object')
									$.extend( ajaxOpt, self.options.ajax_option );
								$.ajax(ajaxOpt);
								break;
