...
$.keyboard = function(el, options){
	...
	base.init = function(){
		...
		// Bind events
		$.each('initialized beforeVisible change visible hidden canceled accepted beforeClose'.split(' '), function(i,f){
			if ($.isFunction(o[f])){
	...
	base.reveal = function(){
		...
		setTimeout(function(){
			base.opening = false;
			if(!base.$preview.is(":focus")) base.$preview.focus(); // for IE - doesn't seem to work =(
		}, 500);
